...
url:
    ...
    type: string
    sample: "http://192.168.7.9:79/hos-4.0.0/hyperv_venv/nova-20160101T101530Z.zip"
svc_dir:
...
EXAMPLES = '''
  ...
  - name: building uri
    build_uri:
      service: nova
      conf_path: 'c:\Program Files\HPE\Helion\etc'
      cache_path: 'c:\Program Files\HPE\Helion\cache'
'''
